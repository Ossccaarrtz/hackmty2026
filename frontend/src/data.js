...
export function appendChatExchange(session, userText, response) {
  ...
  const READ_ONLY_TOOLS = ['get_status', 'get_score_history', 'get_budget_status', 'get_smart_allocation', 'get_upcoming_expenses', 'simulate_decision', 'get_financial_lesson'];
