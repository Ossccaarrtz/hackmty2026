  ...
  <motion.main className={`dashboard connected-dashboard ${isFullPage ? 'full-page-layout page-focused' : ''}`} variants={dashboardContainer} initial="hidden" animate="visible">
    ...
    <section className="main-column">
      ...
      <AnimatePresence mode="popLayout" initial={false}>
        ...
        {page === 'home' && signals?.activation && <motion.section className="glass" key="bank-signals-card" variants={dashboardItem} whileHover={hoverLift} transition={{ duration: 0.2 }}>
          <header className="card-heading"><h2>Actividad con tu tarjeta del banco</h2></header>
