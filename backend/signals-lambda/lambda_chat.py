...
TOOLS = [{
    "functionDeclarations": [
        ...
        },
        {
            ...
            "description": "Mueve un monto de la cuenta corriente al ahorro. Se rechaza si el monto es mayor al limite autonomo permitido, o si hay una anomalia de gasto sin resolver.",
            "parameters": {
                "type": "object",
                "properties": {
                    "amount": {"type": "number"},
...
SYSTEM_INSTRUCTION = (
    ...
    "2) Nunca llames stop_subscription o move_to_savings sin que el usuario lo haya pedido o confirmado explicitamente en la conversacion. "
...
def lambda_handler(event, context):
    ...
    for _ in range(4):
        try:
            ...
            return _response(200, {"reply": f"No pude conectar con el modelo: {e}", "actions_taken": actions_taken})

        if "candidates" not in result or not result["candidates"]:
            return _response(200, {"reply": "El modelo no genero respuesta.", "actions_taken": actions_taken, "_raw": result})
